...
const config = {
  ...
  module: {
    ...
    rules: [
      ...
      {
        test: /\.md$/,
        loader: path.resolve(__dirname, './lib/markdownLoader.js'),
      },
...
const clientConfig = {
  ...
  entry: {
    client: ['whatwg-fetch', '@babel/polyfill', './src/client.tsx'],
  },
